...
graph1 <- ggplot(table4, aes(party, total_trans)) + 
  geom_boxplot(aes(color = ge_winner))

graph1

#graph2 <- ggplot(table4, aes(state, total_trans, color = ge_winner)

#qplot(x = state, y = total_trans, data = table4, color = ge_winner, facet_grid(state))
