...
```{r}
#Join contributions and my_candidate by state and cand_id
#table1 <- inner_join(my_contributions, my_candidate, by = c("cand_id", "state"))

#Join all three datas: contribution, candidate, committees by state and cand_id
#table2 <- inner_join(table1, my_committees, by = c("cand_id","state","cmte_id"))
